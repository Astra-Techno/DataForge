...
class QueryHelper
{
    ...
    public function get($select_type = 'list')
    {
        $this->set('select_type', $select_type);
    ...
    public function getSelect()
    {
        ...
        if ($type != '' && !in_array($type, array_keys($this->select))) {
            $this->setError($this->_name.' - Invalid select type ('.$type.')!');
            //throw new Exception('Invalid select type ('.$type.')!');
            return false;
        }
